...
const Tweet = () => {
    ...
    return (
        ...
        <div name="tweet-container" className="container mx-auto border-t border-r border-l border-grey-textTwitter border-opacity-25 px-4 py-2 max-w-screen-sm">
            ...
            <div name="contenido-tweet">
                ...
                {(tweet.media) ?
                    <div name="media">
                        <img alt="media" src={tweet.media} className="rounded border-grey border cursor-pointer" />
                    </div>
                    : null}
